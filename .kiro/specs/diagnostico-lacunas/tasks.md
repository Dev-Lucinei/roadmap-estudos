...
- [x] 1.1 Configurar estrutura de diretórios conforme design.md
...
- [x] 2.2 Implementar endpoint de diagnóstico no backend
...
- [x] 2.3 Implementar tratamento de erro e timeouts
...
- [x] 3.1 Adicionar funções de diagnóstico ao app.js
...
- [x] 3.2 Integrar diagnóstico ao fluxo de tópicos avançados
...
- [x] 3.3 Implementar estilos CSS para modo foco
...
- [x] 4.3 Validar UI e experiência do usuário
...
- [x] T.1 Testes unitários para toda lógica de negócio
  - Executar testes de unidade para backend e frontend
  - _Requirements: Req. Testabilidade_

- [x] T.2 Testes de integração para fluxos ponta-a-ponta
  - Simular fluxo completo de diagnóstico
  - _Requirements: Req. Testabilidade_

- [x] T.3 Gate final de qualidade
